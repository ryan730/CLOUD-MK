...
const qiniuIsConfiged = ['accessKey', 'secretKey', 'bucketName'].every(key => !!settingsStore.get(key))// 是否可以显示七牛跟踪
console.log("qiniuIsConfiged::", qiniuIsConfiged);
...
},
{
  ...
  submenu: [{
    ...
    click: () => {
      let enableAutoSync = settingsStore.get('enableAutoSync');
      console.log('enableAutoSync:::', enableAutoSync);
